...
dependencies {
    ...
    compile("io.titandata:nop-remote-client:0.0.3")
    compile("io.titandata:ssh-remote-client:0.0.4")
    compile("io.titandata:s3-remote-client:0.0.3")
    compile("io.titandata:s3web-remote-client:0.0.2")
    compile("io.titandata:delphix-remote-client:0.0.2")
}
